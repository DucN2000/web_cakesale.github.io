                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="hero__text">
                            <h2>Thêm hương vị cho cuộc sống</h2>
                            <a href="#" class="primary-btn">Bánh ngọt</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="hero__item set-bg" data-setbg="img/hero/hero-1.jpg">
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="hero__text">
                            <h2>Làm cuộc sống bạn ngọt ngào hơn</h2>
                            <a href="#" class="primary-btn">Bánh ngọt</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="about__text">
                    <div class="section-title">
                        <span>Thông tin về cửa hàng của chúng tôi</span>
                        <h2>Bánh Ngọt Ngon Siêu Cấp</h2>
                    </div>
                    <p>Được làm và hoàn thiện từ những nghệ nhân hàng đầu</p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                        ...
                        <div class="product__item__text">
                            ...
                            <div>
                                <button class="btn primary-btn mt-4">
                                    <a style="color: white" href="cart.php?id=<?php echo $value['ProductId'] ?>">Thêm vào giỏ hàng</a>
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 p-0">
                <div class="instagram__text">
                    <div class="section-title">
                        ...
                        <h2>Lưu thêm nhiều công thức làm bánh ngọt</h2>
                    </div>
                    <h5><i class="fa fa-instagram"></i> @Cake_sale</h5>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="row">
